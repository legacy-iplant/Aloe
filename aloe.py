...
class Application(Frame):
    ...
    def printthing(self):
        global currentList
        print map(int, self.listBox.curselection())
    ...
    def createWidgets(self):
        ...
        self.specificsEntry.grid(row=3, column=1, pady=10, padx=30)
        ...
        self.resultTypeEntry.grid(row=4, column=1, pady=10, padx=30)
        ...
        self.label5["text"] = "Selected List"
        self.label5.grid(row=5, column=0, pady=20)

        self.listBox = Listbox(self, selectmode=EXTENDED)
        self.listBox.config(height=30, width=100)
        self.listBox.grid(row=6, column=0, columnspan=3)

        #self.clear = Button(self)
        #self.clear["text"] = "Clear"
        #self.clear["command"] = self.clearListBox
        ...
        self.listDelete.grid(row=2, column=2)
